...
const texto = [
  ...
  'O /Yoga está intimamente relacionado a palavra /anuśāsana, que deriva das palavras /anu, que significa <i>conectado com</i>, e /śāsana, que significa <i>método</i>. O /Yoga é, portanto, um método conectado com aqueles sábios antigos e professores que vieram antes, é um método que se formou ao longo das eras, transmitido de professor para aluno, que foi finalmente compilado por /Patañjali.',
  ...
  'Das diversas formas atuais de /Yoga, possivelmente uma das que se mantém mais fiel aos ensinamentos dos sábios antigos é o /Haṭha /Yoga.'];
      ...
      <CursosContentAbout>
        ...
        <T.Cita>
          ...
          <T.Sk>
            ...
            as impurezas da mente,
            <br />
            firme na visão do discernimento, surge o brilho
